...
var EcoSun = function(){
	...
	var scrollTop = function (){
		...
		scrollTop.on('click',function() {
			var phoneNumber = "7878393264";
			var message = "Hello, Get a Free Quote!";
			var whatsappURL = "https://wa.me/917878393264";
		...
		jQuery(window).on('scroll', function() {
			...
			if (scroll > 500) {
				...
				jQuery("button.scroltop").fadeOut(300);
			}
		});
	...
	var handleICnavScroll = function(){
